import { Box, Button, Rating, Typography, styled, useMediaQuery } from "@mui/material";
import React from "react";
import verified from "@Assets/Images/verified.gif";
import new_thumb from "@Assets/Images/new_thumb_icon.svg";
import { BlackNormalLocationIcon } from "@Icons/index";
const CardWrapper = styled(Box)<{isMobile:boolean}>(({ theme ,isMobile}) => ({
  border:!isMobile&& `1px solid ${theme.misc.borderColor}`,
  borderRadius: "12px",
  padding:!isMobile&&theme.spacing(8),
  width:isMobile?"100%": theme.spacing(240),
  minWidth:isMobile?"100%": theme.spacing(240),
  height:!isMobile&& theme.spacing(105),
  boxSizing: "border-box",
  backgroundColor: theme.misc.cardBG,
