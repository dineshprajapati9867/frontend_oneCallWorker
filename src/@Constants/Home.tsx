...
const skills = [
  ...
  { id: 12, label: "Car Mechanic", value: "Car Mechanic" },
  ...
  { id: 19, label: "Mobile Repair", value: "Mobile Repair" },
  { id: 20, label: "Washing Machine Repair", value: "Washing Machine Repair" },
  { id: 21, label: "TV repair", value: "TV repair" },
